...
#define for_each_lt(name, size) int32 UNIQUE_NAME(name) = (size); for(uint32 name = 0; name < UNIQUE_NAME(name); name += 1)
#define for_each_in_range(name, r0, r1) int32 UNIQUE_NAME(name) = (r1); for(uint32 name = (r0); name <= UNIQUE_NAME(name); name += 1)
#define NULLOP() 0
